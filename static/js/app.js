...
function buildCharts(id,data) {
   ...
   // Build a Bubble Chart
    var traceBubble = {
      ...
      mode: 'markers',
      marker: {color: sampleData.otu_ids, size: sampleData.sample_values, colorscale:'portland', colorbar: {tickvals: [2,3663]}} // Specific ticks on the color bar
    };
...
function optionChanged(newSample) {
  json.then( data => {
    ...
    Plotly.restyle("bubble", 'marker', [{color: newData.otu_ids, size: newData.sample_values, colorscale:'portland', colorbar: {tickvals: [2,3663]}}]);
    // Redraw Bar Charts
